export default {
    ...
    getTranslations(translations, key, codes) {
        return translations
            .filter(translation => codes.includes(translation[key]))
    ...
    sortCreators(creators) {
        ...
        creators.forEach(creator => {
            ...
            if (indexOfItem === -1)
                ...
                arr[indexOfItem]['jobs'].push(creator['job']);
        });
        return arr;
    },
    initLoader() {
