...
export const useAuthStore = defineStore('authStore', () => {
  ...
  function setCredentials(userArg: User, accessTokenArg: string) {
    user.value = userArg
  ...
  async function refresh(refreshToken: string | null): Promise<AuthResponse>{
    return new Promise(async (resolve, reject) => {
  ...
  async function google(token: string): Promise<AuthResponse>{
    return new Promise(async(resolve, reject) => {
      try {
