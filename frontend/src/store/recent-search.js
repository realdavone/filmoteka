...
export const useRecentSearchStore = defineStore('recentSearch', () => {
    const recentSearch = ref(JSON.parse(localStorage.getItem('recentSearch') ?? '[]'));
    function addSearchQuery(item) {
    ...
    function removeSearchQuery(item) {
...
//# sourceMappingURL=recent-search.js.map