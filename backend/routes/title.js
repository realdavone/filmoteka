...
router.get('/find/:type/:id', async (req, res) => {
  ...
  if(foundTitle === null) {
    res.json({ ...data, omdb: { ...omdbData }, ...foundTitle?._doc, isRecommended: false })
    return
  }
...
router.post('/non-working', auth, async (req, res) => {
...
router.delete('/recommend', auth, async (req, res) => {
